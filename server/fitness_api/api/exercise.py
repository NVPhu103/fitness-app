...
from fitness_api.schemas.exercise import PostExerciseModel, PatchExerciseModel, ExerciseModel
...
@router.post("", response_model=ExerciseModel, summary="Create a exercise", status_code=201)
