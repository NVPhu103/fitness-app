...
@router.get(
    "/{user_id}", response_model=Optional[UserProfileModel], summary="Get a user profile", status_code=200
)
async def get_food(
    request: Request,
    response: Response,
...
@router.post("", response_model=UserProfileModel, summary="Create a user profile", status_code=201)
